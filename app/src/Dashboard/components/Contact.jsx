...
const Contact = ({ menuItems, activeMenu }) => {
    ...
    return (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-500 text-xs md:text-sm">List Of Contacts</p>
          </div>
          <div className="flex w-full sm:w-auto space-x-2 md:space-x-3">
            <button onClick={()=>handleOpenMessageBox(true, false, "Export contact", 
            "info", "This action will create an excel record on all the contact record","Cancel", "OK")} 
            className="flex-1 sm:flex-none bg-white border border-slate-200 text-slate-600 px-3 md:px-4 py-2 rounded-xl text-xs md:text-sm font-semibold hover:bg-slate-50 transition-colors">
              Export</button>
            <button onClick={()=>handleOpenDialogBox(true, false, "New Contact", "Please Enter Details of The Contact")}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <div className="lg:col-span-4 bg-white p-5 md:p-8 rounded-3xl border border-slate-100 shadow-sm mt-6 overflow-hidden">
               <h3 className="text-base md:text-lg font-bold text-slate-800 mb-6">Contact Records</h3>
                 ...
                 <table className="w-full text-left min-w-[600px]">
                   <thead>
                     <tr className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-wider border-b border-slate-50">
                       <th className="pb-4 px-2">Contact ID</th>
                       <th className="pb-4">Person ID</th>
                       <th className="pb-4">Address</th>
                       <th className="pb-4">Social_media</th>
                       <th className="pb-4">State</th>
                       <th className="pb-4">Country</th>
                       <th className="pb-4">Phone</th>
                       <th className="pb-4">Email</th>
                       <th className="pb-4">Occupation</th>
                       <th className="pb-4">Ethnicity</th>
                       <th className="pb-4">Marital_status</th>
                   ...
                   <tbody className="text-xs md:text-sm">
                     {[1,2,3,4,5].map(i => (
                       <tr key={i} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                         ...
                         <td className="py-4 font-bold text-slate-700">Person ID</td>
                         <td className="py-4 text-slate-500">Address {i}</td>
                         <th className="pb-4">Social Media {i}</th>
                         <th className="pb-4">State {i}</th>
                          <th className="pb-4">Country {i}</th>
                          <th className="pb-4">+233 555 555 55{i}</th>
                          <th className="pb-4">person{i}@gmail.com</th>
                          <td className="py-4 text-slate-700">Farmer</td>
                          <td className="py-4 text-slate-700">Yoruba</td>
                          <th className="pb-4">Single</th>
                          <td className="py-4 text-right">
                           <button onClick={()=>handleOpenDialogBox(false, true, "Update Contact", "Please Enter New Details Below")}
               ...
               children={
                <div className="space-y-6 py-2">
                   <div className="space-y-1.5">
                       <label htmlFor="marital_status" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="person" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Person</label>
                        <select name="person"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none">
                           <option value="" selected disabled>Select Person</option>
                           <option value="1">okubor owa</option>
                           <option value="2">okubor owa</option>
                           <option value="3">okubor owa</option>
                           <option value="4">okubor owa</option>
                           <option value="5">okubor owa</option>
                        </select>
                   </div>

                    <div className="space-y-1.5">
                       <label htmlFor="address" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Address</label>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="social_media_url" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Social Media URL</label>
                        <input name="social_media_url" type="url" placeholder="Enter social media URL"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none"/>
                   </div>

                   <div className="space-y-1.5">
                       <label htmlFor="state" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        State</label>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="country" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Country</label>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="occupation" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Occupation</label>
                        <input name="occupation" type="text" placeholder="Enter occupation"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none"/>
                   </div>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="ethnicity" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Ethnicity</label>
                        <input name="ethnicity" type="text" placeholder="Enter ethnicity"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none"/>
                   </div>
