...
const Evidence = ({ menuItems, activeMenu }) => {
    ...
    return (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-500 text-xs md:text-sm">Evidence File Records</p>
          </div>
          <div className="flex w-full sm:w-auto space-x-2 md:space-x-3">
            <button onClick={()=>handleOpenDialogBox(true, false, "New Evidence", "Please Enter Details of The Evidence")}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <div className="lg:col-span-4 bg-white p-5 md:p-8 rounded-3xl border border-slate-100 shadow-sm mt-6 overflow-hidden">
               <h3 className="text-base md:text-lg font-bold text-slate-800 mb-6">Evidence Records</h3>
                 ...
                 <table className="w-full text-left min-w-[600px]">
                   <thead>
                     <tr className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-wider border-b border-slate-50">
                       ...
                       <th className="pb-4">File1</th>
                       <th className="pb-4">File2</th>
                       <th className="pb-4">File3</th>
                       <th className="pb-4">File4</th>
                   ...
                   <tbody className="text-xs md:text-sm">
                     {[1,2,3,4,5].map(i => (
                       <tr key={i} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                         ...
                         <th className="pb-4 text-blue-600">
                         ...
                         <th className="pb-4 text-blue-600">
                          ...
                          <td className="py-4 text-right">
                           <button onClick={()=>handleOpenDialogBox(false, true, "Update Evidence", "Please Enter New Details Below")}
               ...
               children={
                <div className="space-y-6 py-2">
                   <div className="space-y-1.5">
                    ...
                    <div className="space-y-1.5">
                       <label htmlFor="file1" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        File One</label>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="file2" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        File Two(optional)</label>
                        <input name="file2" type="file"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none"/>
                   </div>

                   <div className="space-y-1.5">
                       <label htmlFor="file3" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        File Three(optional)</label>
                        <input name="file3" type="file"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none"/>
                   </div>

                   <div className="space-y-1.5">
                       <label htmlFor="file4" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        File Four(optional)</label>
