...
const Investigation = ({ menuItems, activeMenu }) => {
    ...
    return (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-500 text-xs md:text-sm">Investigations</p>
          </div>
          <div className="flex w-full sm:w-auto space-x-2 md:space-x-3">
            <button onClick={()=>handleOpenDialogBox(true, false, "New Investigation", "Please Enter Details of The Investigation")}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <div className="lg:col-span-4 bg-white p-5 md:p-8 rounded-3xl border border-slate-100 shadow-sm mt-6 overflow-hidden">
               <h3 className="text-base md:text-lg font-bold text-slate-800 mb-6">Investigation Records</h3>
                 ...
                 <table className="w-full text-left min-w-[600px]">
                   <thead>
                     <tr className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-wider border-b border-slate-50">
                       ...
                       <th className="pb-4">Allegation ID</th>
                       <th className="pb-4">Safety Plan</th>
                       <th className="pb-4">Response Type</th>
                   ...
                   <tbody className="text-xs md:text-sm">
                     {[1,2,3,4,5].map(i => (
                       <tr key={i} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                         ...
                         <td className="py-4 text-slate-500">Plan</td>
                         <td className="pb-4 text-blue-600">
                          Response Type
                         </td>
                          <td className="py-4 text-right">
                           <button onClick={()=>handleOpenDialogBox(false, true, "Update Investigation", "Please Enter New Details Below")}
               ...
               children={
                <div className="space-y-6 py-2">
                   <div className="space-y-1.5">
                       <label htmlFor="allegation" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Allegation</label>
                        <select name="allegation"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none">
                           <option value="" selected disabled>Select Allegation</option>
                    ...
                    <div className="space-y-1.5">
                       <label htmlFor="plan" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Safety Plan</label>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="response" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Response Type</label>
