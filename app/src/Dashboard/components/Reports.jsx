...
const Reports = ({ menuItems, activeMenu }) => {
    ...
    return (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-500 text-xs md:text-sm">List Of Reports</p>
          </div>
          <div className="flex w-full sm:w-auto space-x-2 md:space-x-3">
            <button onClick={()=>handleOpenMessageBox(true, false, "Export report", 
            "info", "This action will create an excel record on all the report record","Cancel", "OK")} 
            className="flex-1 sm:flex-none bg-white border border-slate-200 text-slate-600 px-3 md:px-4 py-2 rounded-xl text-xs md:text-sm font-semibold hover:bg-slate-50 transition-colors">
              Export</button>
            <button onClick={()=>handleOpenDialogBox(true, false, "New Report", "Please Enter Details of The Report")}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <div className="lg:col-span-4 bg-white p-5 md:p-8 rounded-3xl border border-slate-100 shadow-sm mt-6 overflow-hidden">
               <h3 className="text-base md:text-lg font-bold text-slate-800 mb-6">Report Records</h3>
                 ...
                 <table className="w-full text-left min-w-[600px]">
                   <thead>
                     <tr className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-wider border-b border-slate-50">
                       <th className="pb-4 px-2">Report ID</th>
                       <th className="pb-4">Reporter ID</th>
               ...
               children={
                <div className="space-y-6 py-2">
                   <div className="space-y-1.5">
                    ...
                    <div className="space-y-1.5">
                       <label htmlFor="source" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Source</label>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="summary" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Summary</label>
                        <textarea name="summary" placeholder="Enter summary"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none"/>
                   </div>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="status" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Status</label>
                        <input name="status" type="text" disabled placeholder="New"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none"/>
                   </div>
                   ...
                   <div className="space-y-1.5">
                       <label htmlFor="date" className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-1">
                        Date</label>
                        <input name="date" type="datetime-local" placeholder="12/19/2023:00:00:00"
                        required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#2E8B57]/20 transition-all font-medium text-slate-900 appearance-none"/>
                   </div>
