...
const Dashboard = ({ onLogout }) => {
  ...
  const renderContent = () => {
    if (activeMenu === 'Dashboard Home') {
      return <Home menuItems={menuItems} activeMenu={activeMenu} />;
    }else if (activeMenu === 'Abuse Type'){
      return <AbuseType menuItems={menuItems} activeMenu={activeMenu} />;
    }else{
      return <PlaceHolder menuItems={menuItems} activeMenu={activeMenu} />;
    }
  };
